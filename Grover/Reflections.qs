namespace Reflections {
    ...
    operation ReflectAboutUniform(inputQubits : Qubit[]) : Unit {
        within {
            ...
            RelfectAboutAllOnes(inputQubits);
        }
    }

    /// # Summary
    /// Reflects about the all-ones state
    operation RelfectAboutAllOnes(inputQubits : Qubit[]) : Unit {
    ...
    /// # Summary
    /// Given a register in the all-zeros state, prepares an all-ones state by flipping every qubit.
